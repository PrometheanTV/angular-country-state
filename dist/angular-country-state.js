  ...
  angular
        ...
        .directive('countryStateSelect', [function () {
          return {
            restrict: 'E',
            template: template,
            scope: { country: '=?', countryState: '=?state', defaultCountry: '=?', showError: '=?' },
            link: function (scope, element, attrs) {
              ...
              if ((typeof scope.country == 'undefined') && typeof attrs.defaultCountry != 'undefined') {
                ...
                console.log('Setting Default Country', attrs.defaultCountry);
                ...
                console.log('Setting Country', scope.country);
                scope.selectCountry();
              } else {
